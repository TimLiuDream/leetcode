...
import (
	...
	"github.com/timliudream/leetcode/sort/models"
	"github.com/timliudream/leetcode/sort/sortlib"
)
...
func func1() {
	...
	sortlib.BubbleSort1(s1)
	fmt.Println(s1)

	// 插入排序
	s2 := []int{1, 5, 8, 3, 2, 1, 5, 8, 2, 4}
	sortlib.InsertionSort(s2)
	fmt.Println(s2)
}
